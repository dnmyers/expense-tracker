...
const options = {
    ...
    reducers: {
        editBudget: (state, action) => {
            state.budgets[action.payload.category].amount = action.payload.amount;
            console.log('state.budgets: ' + JSON.stringify(state.budgets));
            console.log('state.budgets[housing]: ' + state.budgets['housing']);
